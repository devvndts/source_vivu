...
class QuestionController extends Controller
{
    ...
    public function ShowQuestion($response, Request $request){
        //### lấy dữ liệu
        ...
        $question = $this->questionRepo->GetQuestions(['duyettin'=>1,'hienthi'=>1], null, true, false);
        ...
        return view('desktop.templates.cauhoi.question')->with($response);
    }
}

...
use App\Payment\Utils\AlepayUtils;
...
class Alepay
{
    ...
    public function getTransactionInfoV3($transactionCode)
    {
        $data['tokenKey'] = $this->apiKey;
        ...
        $dataInfo['tokenKey'] = $this->apiKey;
        $dataInfo['transactionCode'] = $transactionCode;

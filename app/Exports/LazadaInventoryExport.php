...
class LazadaInventoryExport implements FromView, WithStyles, ShouldAutoSize
{
    ...
    */
    ...
    {
        $products = $this->productRepo->GetAllItems('product', null, ['HasProductOptions', 'HasProductOptionsSample']);
        return view('admin.exports.lazada.inventory', [
            'products' => $products
        ]);
    }

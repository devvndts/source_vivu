		            ...
		            <div class="box-product-info">
		            	<div class="box-product-detail">
		            		...
		            		<div class="box-product-price">
		            			<p class="box-product-newprice">{{Helper::Format_Money($pricebetween['giamin'] ?? 0)}}</p>
		            			<span>-</span>
		            			<p class="box-product-oldprice">{{Helper::Format_Money($pricebetween['giamax'] ?? 0)}}</p>
		            		</div> 
		            		<div class="box-product-price">

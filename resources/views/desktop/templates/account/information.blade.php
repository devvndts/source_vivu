...
<div class="container my-6">
    <div class="mb-5 login-layout">
		...
		@endphp
		<div class="mb-5 login-layout">
            <form id="login-form" class="form-user change-css-date validation-user" novalidate method="post" action="{{route('account.information')}}" enctype="multipart/form-data">
				@csrf
                <div class="login-form-title">{{$title_crumb}}</div>
				<div class="login-form-box">
					<label for="name">{{hoten}}</label>
					<p>
						<input id="ten" type="text" name="name" placeholder="" value="{{$rowItem['name']}}">
				...
				<div class="login-form-box">
					...
					<p>
						<input id="ngaysinh" type="text" name="ngaysinh" placeholder="" value="{{ date("Y-m-d", $rowItem['ngaysinh']) }}">
				...
				<div class="login-form-box">
					...
					<p>
						<input id="phonenumber" type="text" name="phonenumber" placeholder="" value="{{$rowItem['phonenumber']}}">
				...
				<div class="login-form-box">
					...
					<p>
						<input id="username" type="text" name="username" placeholder="" value="{{$rowItem['username']}}">
                ...
                <div class="login-form-box">
					<label for="password">{{matkhaucu}}</label>
					<p>
					...
					{{-- <span class="login-form-alert">{{(isset($validates['new_password'])) ? $validates['new_password'][0] : ''}}</span> --}}
				</div>
				<div class="login-form-box">
				...
				<div class="login-form-box">
					...
					{{-- <span class="login-form-alert">{{(isset($validates['new_password_confirm'])) ? $validates['new_password_confirm'][0] : ''}}</span> --}}
				</div>
                @endif
				<div class="login-form-box">
					<label for="email">Email</label>
					<p>
						<input id="email" type="email" name="email" placeholder="" value="{{$rowItem['email']}}">
				...
				<div class="login-form-flex">
					<input type="submit" class="login-form-submit" value="{{capnhat}}" >
				</div>
			</form>
		</div>
    </div>

...
<div class="home-ketnoi-container bortop padlr">
	<div class="center-layout-ketnoi home-ketnoi-main">
		<div class="home-ketnoi-left">
			...
			<span class="home-ketnoi-name"><img src="{{ (isset($photo_static['logo']['photo']))?Thumb::Crop(UPLOAD_PHOTO,$photo_static['logo']['photo'],185,0,2):'' }}" onerror=src="{{asset('img/noimage.png')}}" alt="Logo"></span>

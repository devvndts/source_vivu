	...
	<div class="detail_product_sticky">
		<div class="detail__right bortop">
			...
			@if(isset($size) && count($size)==0)
				...
				@endphp
				<div class="py-3 detail__properties detail__properties__size d-none">
					<div class="flex flex-wrap" id="product_detail_size">
						<a class="mr-1 size-pro-detail text-decoration-none active SizefirstOption" data-id="{{$row_detail['id']}}">
			...
			<div class="detail__button__grid py-2 fix_button_cart mobile_button_cart {{($is_soluong) ? 'btn-cart-grid' : 'btn-cart-hidden'}}" id="show_btn_mobile_conhang">
				<button type="button" class="flex items-center justify-center detail__button detail__wishlist js-action-cart" data-id="{{$row_detail['id']}}" data-action="addnow">
			...
			@if(isset($settingOption['zalo']) || isset($settingOption['messenger']))
			<div class="contact-phone">
				<ul>
					@if(@$settingOption['zalo'] )
					<li>
			...
			<div class="detail__button__grid py-2 {{($is_soluong) ? 'fix_button_cart btn-cart-grid' : 'btn-cart-hidden'}}" id="show_btn_conhang">
				...
				{{-- <button type="button" class="flex justify-content-center align-items-center detail__button detail__buynow js-action-cart" data-id="{{$row_detail['id']}}" data-action="buynow">
					<span>Mua ngay</span>
					<i class="ml-2 fal fa-shopping-bag"></i>
				</button> --}}
			</div>
...
<div>
	...
	<div class="py-4 bg-white bortop">
		<div class="container clearfix center-layout">

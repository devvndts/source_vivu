    ...
    <div class="mail-container">
        ...
        <div class="mail-body">
            <div class="mail-content-inform" style="background: no-repeat url({{config('config_all.config_all_url')}}img/mail/logo-mikotech.png) center;background-size: contain;">
                <p class="mail-title">{{($setting) ? $setting['tenvi'] : 'Chúng tôi'}} xin thông báo!<br> Tài khoản của quý khách đã đăng ký thành công, vui lòng nhấp <a href="{{route('account.active',['email'=>md5($user['email'])])}}" target="_blank"> tại đây </a>để kích hoạt tài khoản</p>                
            </div>
        </div>

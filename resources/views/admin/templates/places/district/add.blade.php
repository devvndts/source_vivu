...
@section('content')
<form class="validation-form" novalidate method="post" action="{{route('admin.places.save',['cat'])}}" enctype="multipart/form-data">
	@csrf
    <div class="card-footer text-sm sticky-top">
        ...
        <a class="btn btn-sm bg-gradient-danger" href="{{route('admin.places.show',['cat'])}}" title="Thoát"><i class="fas fa-sign-out-alt mr-2"></i>Thoát</a>
    </div>
    <div class="row">
        <div class="col-xl-12">
            <div class="card card-primary card-outline text-sm">
                <div class="card-header">
                    <h3 class="card-title">{{(isset($rowItem['id']))?"Cập nhật":"Thêm mới"}}  Quận huyện</h3>

...
@section('content')
<form class="validation-form" novalidate method="post" action="{{route('admin.places.save',['man'])}}" enctype="multipart/form-data">
	@csrf
    <div class="card-footer text-sm sticky-top">
        ...
        <a class="btn btn-sm bg-gradient-danger" href="{{route('admin.places.show',['man'])}}" title="Thoát"><i class="fas fa-sign-out-alt mr-2"></i>Thoát</a>
    </div>
    <div class="row">
        <div class="col-xl-12">
            <div class="card card-primary card-outline text-sm">
                <div class="card-header">
                    <h3 class="card-title">{{(isset($rowItem['id']))?"Cập nhật":"Thêm mới"}}  Phường xã</h3>
                ...
                <div class="card-body">
                    <div class="form-group-category row">
	                    <div class="form-group col-md-3 col-sm-4">
							...
							{!! Helper::get_ajax_places("places", "places", "list", null, $rowItem) !!}
	                    </div>
                        <div class="form-group col-md-3 col-sm-4">
	                        <label class="d-block" for="id_district">Danh sách quận huyện:</label>
							{!! Helper::get_ajax_places("places", "places", "cat", null, $rowItem) !!}
	                    </div>
                        <div class="form-group col-md-3 col-sm-4">
	                        <label class="d-block" for="id_district">Danh sách phường xã:</label>
							{!! Helper::get_ajax_places("places", "places", "item", null, $rowItem) !!}
	                    </div>
	                </div>
    ...
    <div class="card-footer text-sm">
        ...
        <button type="submit" class="btn btn-sm bg-gradient-success submit-check" name="savehere"><i class="far fa-save mr-2"></i>Lưu tại trang</button>
        <button type="reset" class="btn btn-sm bg-gradient-secondary"><i class="fas fa-redo mr-2"></i>Làm lại</button>
        <a class="btn btn-sm bg-gradient-danger" href="{{route('admin.places.show',['item'])}}" title="Thoát"><i class="fas fa-sign-out-alt mr-2"></i>Thoát</a>
